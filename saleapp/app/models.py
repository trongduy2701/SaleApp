...
class User(db.Model, UserMixin):
    ...
    avatar = Column(String(100), default='https://cdn.tgdd.vn/Products/Images/42/299033/iphone-15-pro-black-thumbnew-600x600.jpg')
...
if __name__ == '__main__':
    with app.app_context():
        ...
        import hashlib
        u = User(name='Admin', username='admin', password=str(hashlib.md5('123456'.encode('utf-8')).hexdigest()), image='https://bacanhem.vn/Design/man.png')
        db.session.add(u)
        db.session.commit()
